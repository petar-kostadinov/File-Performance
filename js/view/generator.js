            ...
            <h1>Select options</h1>
                <div class="radio-group">
                    <div>
                      ...
                      <img class="radio-img" src="https://petar-kostadinov.github.io/File-Performance/images/Simon.jpg" alt="">
                    </div>

                    <div>
                      <input type="radio" id="option2" name="options" value="Hanna">
                      <label for="option2">Hanna</label>
                      <img class="radio-img" src="https://petar-kostadinov.github.io/File-Performance/images/Hanna.jpg" alt="">
                    </div>

                    <div>
                       <input type="radio" id="option3" name="options" value="Mathis">
                       <label for="option3">Mathis</label>
                       <img class="radio-img" src="https://petar-kostadinov.github.io/File-Performance/images/Mathis.jpg" alt="">
                    </div>

                    <div>
                       <input type="radio" id="option4" name="options" value="Ava">
                       <label for="option4">Ava</label>
                       <img class="radio-img" src="https://petar-kostadinov.github.io/File-Performance/images/Ava.jpg" alt="">
                    </div>

                    <!-- <div>
                        <input type="radio" id="option5" name="options" value="">
                        <label for="option4">????????</label>
                        <img class="radio-img" src="https://petar-kostadinov.github.io/File-Performance/images/.jpg" alt="">
                    </div> -->
